...
(function($) {
    ...
    function getImageThumbnailHtml(src) {
        return '<img src="' + src + '" alt="Image preview" id="thumbnail" class="thumbnail" style="max-width: ' + options.maxWidth + 'px; max-height: ' + options.maxHeight + 'px;" onclick=onImageClick(this);>';
    }
    
    function onImageClick(img) {
    	// actual impl will be page specific
    }
